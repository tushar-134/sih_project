...
export default function LoginPage() {
  ...
  const handleSubmit = (e) => {
    ...
    // Add your login logic here - navigate to dashboard or home
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:from-blue-700 hover:to-blue-800 transform hover:scale-105 transition-all duration-200"
            >
              Sign In
            </button>
          </div>
